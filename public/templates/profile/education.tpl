{if $view != "update"}
    <div class="form-group" style="float: right;">
        <a href="{$server}{if $user.type}/employees/update/{$employee.employee_id}/education{else}/update/education{/if}" class="btn btn-secondary btn-sm ml-2"><i class="fe fe-edit-2"></i> Edit</a>
    </div>
...
{else}
<form method = "POST" action="{$server}{if $user.is_admin}/employees/save/{$employee.employee_id}{else}/save{/if}">
